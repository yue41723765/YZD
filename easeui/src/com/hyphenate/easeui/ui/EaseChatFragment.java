...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemdrawables = {R.drawable.message_photo, R.drawable.message_image};
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        yourHead = fragmentArgs.getString("yourHead");
        myHead = fragmentArgs.getString("myHead");

        sharedPreferences = getActivity().getSharedPreferences("myUserInfo", 0);
        editor = sharedPreferences.edit();

        editor.putString("myHead", myHead);
        editor.putString("yourHead", yourHead);
        editor.commit();
